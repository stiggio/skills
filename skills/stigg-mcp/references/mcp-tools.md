...
MCP coverage is broad but not 100% of the Stigg API. When an operation isn't MCP-exposed, fall through to the SDK / REST API (skill: `stigg-api`). For the Stigg CLI (and when to reach for it), see `cli-vs-mcp.md`.
